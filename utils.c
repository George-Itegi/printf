...
/**
 * append_hexad_code - Append ascci in hexadecimal code to buffer
 * @buffer: Array of chars.
 * @i: Index at which to start appending.
 * @ascii_code: ASCI CODE.
 * Return: Always 3
 */
int append_hexad_code(char ascii_code, char buffer[], int i)
{
...
/**
 * convert_size_numbers - Casts a number to the specified size
